...
class Context(str, enum.Enum):
    ...
    READ_FACTS_FILE_FAILED = 'READ_FACTS_FILE_FAILED'
    READ_FACTS_FILE_SUCCEEDED = 'READ_FACTS_FILE_SUCCEEDED'
    DELETE_FACTS_FILE_FAILED = 'DELETE_FACTS_FILE_FAILED'
    DELETE_FACTS_FILE_SUCCEEDED = 'DELETE_FACTS_FILE_SUCCEEDED'
    KBGEN_SUCCEEDED = 'KBGEN_SUCCEEDED'
    KBGEN_FAILED = 'KBGEN_FAILED'
    QUERYENGINE_SUCCEEDED = 'QUERYENGINE_SUCCEEDED'
    QUERYENGINE_FAILED = 'QUERYENGINE_FAILED'
    KBGEN_UPLOADED_FOR_AGENT = 'KBGEN_UPLOADED_FOR_AGENT'
    KBGEN_UPLOAD_FOR_AGENT_FAILED = 'KBGEN_UPLOAD_FOR_AGENT_FAILED'
